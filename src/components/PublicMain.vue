...
<template>
  <div class="object-center">
    <div class="bg-fixed max-md:w-full lg:w-1/2 lg:left-1/2 lg:translate-x-1/2">
      <span>
        <img src="../assets/public1.jpg" alt="메인사진1" />
      </span>
    </div>
  </div>
  <!-- linkList -->
  ...
  >
    <div id="tabs" class="flex justify-between">
      ...
      >
        ...
        <span class="tab tab-kategori block text-xs">Map</span>
      </a>
      <a
        href="#"
        class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1"
      >
        ...
        <span class="tab tab-whishlist block text-xs">Message</span>
      </a>
      <a
        href="#"
        class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1"
      >
        ...
        <span class="tab tab-account block text-xs" @click="sendkakao"
          >카카오톡 공유하기</span
        >
      </a>
    </div>
