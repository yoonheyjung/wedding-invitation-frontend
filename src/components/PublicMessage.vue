    ...
    getMessage: function () {
      ...
      this.comments = [
        ...
        },
        {
          ...
          message: "연두이❤️웰컴 유부월드🥰",
        },
        {
          name: "먹린",
          createdAt: convertKst(1677769079751),
          message: "연두이 너무 예쁘다 ❤️ ❤️ 행복하게 잘살아",
        },
        {
          name: "아람단",
        ...
        },
        {
          ...
          message: "연두씨? 당신 사진 때문에 핸드폰에 과즙 튀었어요. 🍊",
        },
        {
          name: "렛이나",
        ...
        },
        {
          ...
          message: "결혼 축하해 연두~ 오래오래 함께 행복하길 바라🖤",
        },
        {
          name: "공구파트너",
        ...
        },
        {
          ...
          message:
            "연두야~ 결혼 너무너무 축하해♥️ 예쁜 부부의 앞날에 행복만 가득하길 바랍니다! 힘들때 서로 의지하고 위기는 지혜롭게 해결해나가는 건강한 가정이 되기를! 행복하세요☺️",
        },
        {
          name: "제리",
        ...
        },
        {
          ...
          message:
            "드레스마다 연두을 위한 옷 같아요! 따스한 미소를 가진 두 분이 늘 평안하고 행복하기를 바라며 진심으로 축복합니다🥰",
        },
        {
          name: "리낭",
        ...
        },
        {
          ...
          message: "연두야 결혼 축하해❤️ 건강하고 행복하길 응원할게 👏🏻",
        },
        {
          name: "🧸",
          createdAt: convertKst(1678229679279),
          message:
            "연두언니 결혼 진심으로 너무너무 축하해🫶🏻 행복하게 잘 살아야해🎀🤍 이젠 정말 예비신부 얼마 안남았어요 꺅~~~",
        },
        {
          name: "마장동불주먹",
          createdAt: convertKst(1678319063501),
          message:
            "연두 태경님 결혼 축하드려요 세상에서 가장 아름답고 멋진 주인공! 다가올 세월에 길이길이 남을 행복한 부부이기를 무종교지만 마음 다 해 기도합니다❤️",
        },
        {
          name: "윤예지",
          createdAt: convertKst(1678477999897),
          message: "연두야 결혼 너무너무너무너무 축하해!!!!!!!!!!!!",
        },
        {
          name: "한현진",
          createdAt: convertKst(1679010701633),
          message: "ㅋㅋㅋㅋㅋ 오연두 결혼이라니 축하한다 !!!! 잘살구 행복해.",
        },
        {
          name: "토리",
        ...
        },
        {
          ...
          message: "새로운 시작 응원할게 연두야❤️ 좋은 꿈 꾸고 내일 보자",
        },
        {
          name: "대장마오",
        ...
        },
        {
          ...
          message: "찬식. 인옥 친구 아들결혼축하해~~",
        },
      ];
    },
    saveMessage: function () {
      return alert("예식이 종료되어 더이상 메세지를 남기실 수 없습니다 🥲");
    },
  },
};
</script>
